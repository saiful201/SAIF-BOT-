...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("WELCOME")==0 || event.body.indexOf("wlc")==0 || event.body.indexOf("welcome")==0 || event.body.indexOf("Welcome")==0) {
		var msg = {
				body: "WELCOME ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `/noprefix/wlc.png`)
			}
