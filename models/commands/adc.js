...
module.exports.run = async function ({ api, event, args }) {
    const permission = ["100007994598695", "100039840451887"];
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only「๛⃝₍𝐒͜͡𝐚𝐮𝐫͜͡𝐚𝐛𝐡₎̚ 」࿐『𝐱͜͡⃝ᴆ』浴' ", event.threadID, event.messageID);
